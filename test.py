...
if __name__ == "__main__":
    ...
    mydb.set_category(super_id='1', name='ddffff', width='23', height='1', depth='1', iteration='1', thumbnail='1')
    mydb.set_category(super_id='1', name='ddddffff', width='23', height='1', depth='1', iteration='1', thumbnail='1')
